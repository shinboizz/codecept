...
Feature('comment'); // npx codecept-ui --app
let comment = new DataTable(['Fname', 'Lname', 'email', 'phone', 'address', 'comment']);
comment.add(['phong', 'huynh', 'phong@gmail.com', '03334455', 'bienhoa', 'xinchao']);
comment.add(['', '', '', '', '', '']); //null
comment.add(['phong', 'huynh', 'phonggmail.com', '03334455', 'bienhoa', 'xinchao']); //sai gmail
comment.add(['phong', 'huynh', 'phong@gmailcom', '03334455', 'bienhoa', 'xinchao']); // sai gmail
comment.add(['phong', 'huynh', 'phong@gmail.com', 'asdasd', 'bienhoa', 'xinchao']); // sai sdt


Data(comment).Scenario('TC_Comment', ({ I, current }) => {
